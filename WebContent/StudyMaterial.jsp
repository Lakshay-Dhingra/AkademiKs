...
<div class="row pt-3">
    <div class="card col-sm" style="border-style: none;">
      ...
      <img src="img/image6.jpg" class="card-img-top" height="250px" style="border-style:solid;border-color:black;"></a>
      <div class="card-body">
        <h5 class="card-title">E-Books</h5>
        <p class="card-text">Browse through various books of different subjects and read them.</p>
        <a href="NotCompleted.jsp" class="btn btn-primary">Browse Books</a>
      </div>
    </div>

    <div class="card col-sm" style="border-style: none;">
      <a href="NotCompleted.jsp" style="text-decoration:none">
      <img src="img/image5.jpg" class="card-img-top" height="250px" style="border-style:solid;border-color:black;"></a>
      <div class="card-body">
        <h5 class="card-title">Study Notes</h5>
        <p class="card-text">See Study notes posted by your peers and seniors.</p>
        <a href="NotCompleted.jsp" class="btn btn-primary">See Notes</a>
      </div>
    </div>
    
    <div class="card col-sm" style="border-style: none;">
      <a href="NotCompleted.jsp" style="text-decoration:none">
      <img src="img/image7.png" class="card-img-top" height="250px" style="border-style:solid;border-color:black;"></a>
      <div class="card-body">
        <h5 class="card-title">Post Study Material</h5>
        <p class="card-text">Post Notes, e-books, Question papers and other Study Material.</p>
        <a href="NotCompleted.jsp" class="btn btn-primary">Submit Study Material</a>
      </div>
    </div>
</div>
...
<div class="row pt-3">
    <div class="card col-sm" style="border-style: none;">
      <a href="NotCompleted.jsp" style="text-decoration:none">
      <img src="img/image8.png" class="card-img-top" height="250px" style="border-style:solid;border-color:black;"></a>
      <div class="card-body">
        <h5 class="card-title">Question Papers</h5>
        <p class="card-text">See previous year papers and be ready for the exam.</p>
        <a href="NotCompleted.jsp" class="btn btn-primary">See Question Papers</a>
      </div>
    </div>
    
    <div class="card col-sm" style="border-style: none;">
      <a href="NotCompleted.jsp" style="text-decoration:none">
      <img src="img/image9.jpg" class="card-img-top" height="250px" style="border-style:solid;border-color:black;"></a>
      <div class="card-body">
        <h5 class="card-title">Links</h5>
        <p class="card-text">Browse through various websites and youtube links for learning.</p>
        <a href="NotCompleted.jsp" class="btn btn-primary">Browse Links</a>
      </div>
    </div>
    
    <div class="card col-sm" style="border-style: none;">
      <a href="NotCompleted.jsp" style="text-decoration:none">
      <img src="img/image10.jpg" class="card-img-top" height="250px" style="border-style:solid;border-color:black;"></a>
      <div class="card-body">
        <h5 class="card-title">Assignments</h5>
        <p class="card-text">See solution to the assignments posted by your teacher.</p>
        <a href="NotCompleted.jsp" class="btn btn-primary">Assignments Section</a>
      </div>
    </div>
</div>
